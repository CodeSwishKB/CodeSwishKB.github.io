...
class Bottles {
	...
	// **sparse container method**
	// container(){
	// 	return 'bottles'
	// }

	// **emptying method container
	// container(){
	// }

	// **guess entire container**
	// container(number){
	// 	if (number === 1){
	// 		return 'bottle'
	// 	} else{
	...
	verse(number) {
		switch (number) {
			...
			// **2 and default cases indentical**
			// case 2:
			// 	return (
			// 		`${number} bottles of beer on the wall, ` +
			// 		`${number} bottles of beer.\n` +
			...
			// **passing an argument to container**
			// default: 
			// 	return (
			// 		`${number} bottles of beer on the wall, ` +
			// 		`${number} bottles of beer.\n` +
			...
			// **sparse container used in default branch**
			// default:
			// 	return (
			// 		`${number} bottles of beer on the wall, ` +
			// 		`${number} bottles of beer.\n` +
